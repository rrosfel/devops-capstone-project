...
![Build Status](https://github.com/rrosfel/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)

Build and deliver a fully functional Customer Accounts microservice.
